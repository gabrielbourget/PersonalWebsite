			...
			<FromTheTopCradle>
				<article className={ initObject.articleClasses }>
					...
					<p>
						...
						the velocity and energy displayed in the industry have been very exciting to me as I have followed the Javascript explosion centered around new infrastructure 
					...
					<p>
						...
						piano throughout most of my life. Over the past years, I have used that foundation to make the move into learning sound design, music production, and 
						audio engineering. While developing a <a href='https://soundcloud.com/imjuststarstuff/contact' target='_blank' rel='noopen noreferrer'> musical project </a> 
						of my own, I have also worked closely with my sister to develop and release a six-track debut EP for her own 
